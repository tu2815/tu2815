...
' Module level constants
  Private Const URL_API_Remaining  As String = "https://pdftables.com/api/remaining?key=!KEY!"
  Private Const URL_API_PDF2Excel  As String = "https://pdftables.com/api?key=!KEY!&format=xlsx-single"
